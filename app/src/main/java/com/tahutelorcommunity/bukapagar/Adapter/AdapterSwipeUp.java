...
public class AdapterSwipeUp extends RecyclerView.Adapter<RecyclerViewHolder> {

    private List<Product_> itemList;
    private Context context;

    public AdapterSwipeUp(Context context, List<Product_> itemList) {
        super();
