...
public class AdapterTransaksiPenyewa extends RecyclerView.Adapter<RecyclerViewHolder> {

    private List<Product> itemList;
    private Context context;

    public AdapterTransaksiPenyewa(Context context, List<Product> itemList) {
        super();
