...
//                                    Toast.makeText(ResetPasswordActivity.this, getResources().getString(R.string.successfully_send_forgot_email), Toast.LENGTH_SHORT).show();
//                                } else {
//                                    Toast.makeText(ResetPasswordActivity.this, getResources().getString(R.string.failed_recheck_email), Toast.LENGTH_SHORT).show();
//                                }
