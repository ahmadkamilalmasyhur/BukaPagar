...
public class Product {
    ...
    @Expose
    private SellerVoucher_ sellerVoucher;
    ...
    @Expose
    private List<TagPage> tagPages = null;
    @SerializedName("id")
    @Expose
    private String id;
    @SerializedName("url")
    ...
    public SellerVoucher_ getSellerVoucher() {
        return sellerVoucher;
    }

    public void setSellerVoucher(SellerVoucher_ sellerVoucher) {
        this.sellerVoucher = sellerVoucher;
    }
    ...
    public void setTagPages(List<TagPage> tagPages) {
        this.tagPages = tagPages;
    }
