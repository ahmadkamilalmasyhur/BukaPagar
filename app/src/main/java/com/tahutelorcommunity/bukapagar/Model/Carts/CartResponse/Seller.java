...
public class Seller {
    ...
    @Expose
    private Boolean scheduleCloseStore;
     ...
     * @param closeReason
     */
    public Seller(Integer id, String username, String name, String gender, String avatar, String level, String levelBadgeUrl, String lapakName, String lapakDesc, String lapakHeader, String lastLogin, String joinedAt, Boolean verifiedUser, Boolean official, Boolean storeClosed, Boolean scheduleCloseStore, String closeDate, Object reopenDate, String closeReason, String deliveryTime, Rejection rejection, Address address, Integer subscriberAmount, Object lastOrderSchedule, Boolean premiumUser, Boolean topMerchant, SellerVoucher sellerVoucher, Boolean isSeller, Feedbacks feedbacks) {
        super();
        this.id = id;
    ...
    public Boolean getScheduleCloseStore() {
        return scheduleCloseStore;
    }

    public void setScheduleCloseStore(Boolean scheduleCloseStore) {
        this.scheduleCloseStore = scheduleCloseStore;
    }
