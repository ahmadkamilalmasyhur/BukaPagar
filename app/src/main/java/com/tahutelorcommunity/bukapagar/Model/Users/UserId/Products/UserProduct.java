...
public class UserProduct {
    ...
    @Expose
    private Object sellerDeliveryTime;
     ...
     * @param imageIds
     */
    public UserProduct(DealInfo dealInfo, String dealRequestState, Integer price, Integer categoryId, String category, List<String> categoryStructure, List<String> courier, String sellerUsername, String sellerName, Integer sellerId, String sellerAvatar, String sellerLevel, String sellerLevelBadgeUrl, Object sellerDeliveryTime, Integer sellerPositiveFeedback, Integer sellerNegativeFeedback, String sellerTermCondition, String sellerAlert, Boolean forSale, List<Object> stateDescription, Boolean premiumAccount, Boolean topMerchant, Object lastOrderSchedule, SellerVoucher sellerVoucher, Integer waitingPayment, Integer soldCount, Specs specs, Boolean forceInsurance, List<Object> freeShippingCoverage, String id, String url, String name, Boolean active, String city, String province, Integer weight, List<Integer> imageIds, List<String> images, List<String> smallImages, String desc, String condition, Integer stock, Boolean favorited, String createdAt, String updatedAt, List<Object> productSin, Rating rating, String currentVariantName, Integer currentProductSkuId, List<Object> productSku, List<Object> options, Integer interestCount, String lastRelistAt, Integer viewCount) {
        super();
    ...
    public Object getSellerDeliveryTime() {
        return sellerDeliveryTime;
    }

    public void setSellerDeliveryTime(Object sellerDeliveryTime) {
        this.sellerDeliveryTime = sellerDeliveryTime;
    }
