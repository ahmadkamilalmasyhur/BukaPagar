...
//        row.add(Root.COLUMN_TITLE, getContext().getString(R.string.internal_storage)); //this is error
//        row.add(Root.COLUMN_FLAGS, Root.FLAG_LOCAL_ONLY | Root.FLAG_SUPPORTS_CREATE); //this is error
//        row.add(Root.COLUMN_ICON, R.drawable.ic_provider); //this is error
